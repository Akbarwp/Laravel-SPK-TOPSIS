                ...
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        ...
                        <div class="px-3 text-right basis-1/3">
                            <div
                                class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-backgroundSecondary to-greenSecondary">
                        ...
                        <div class="max-w-full px-3 lg:w-1/2 lg:flex-none">
                            <div class="flex flex-col h-full">
                                ...
                                <p class="mb-12">From colors, cards, typography to complex elements, you will find the full
                                    documentation.</p>
                                <a class="mt-auto mb-0 font-semibold leading-normal text-sm group text-slate-500" href="#">
                                    Read More
            ...
            <div
                ...
                <div class="relative h-full overflow-hidden bg-cover rounded-xl" style="background-image: url('{{ asset('img/alena-aenami-rooflinesgirl.jpg') }}')">
                    ...
                    <div class="relative z-10 flex flex-col flex-auto h-full p-4">
                        ...
                        <a class="mt-auto mb-0 font-semibold leading-normal text-white group text-sm" href="#">
                            Read More
                            <i class="ri-arrow-right-line ease-bounce text-sm group-hover:translate-x-1.25 ml-1 leading-normal transition-all duration-200"></i>
                        </a>
                    </div>
